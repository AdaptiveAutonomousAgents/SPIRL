...
from spirl.rlpyt_buffer import AsyncPrioritizedSequenceReplayFrameBufferExtended, \
    AsyncUniformSequenceReplayFrameBufferExtended
from spirl.models import from_categorical, to_categorical
...
class SPRCategoricalDQN(CategoricalDQN):
    ...
    def loss(self, samples):
        ...
        # start = time.time()
        log_pred_ps = self.agent(samples.all_observation.to(self.agent.device),
